                    ...
                    <div class="form-container">
                        ...
                        <form id="kc-register-form" action="${url.registrationAction}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control input-field" name="user.attributes.businessName" maxlength="100" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control input-field" name="email" maxlength="255" required>
                            ...
                            <div class="mb-3">
                                ...
                                <#if messagesPerField.exists('password')>
                                    <div class="text-danger">${kcSanitize(msg(messagesPerField.get('password')))?no_esc}</div>
                                </#if>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <#if messagesPerField.exists('password-confirm')>
                                    <div class="text-danger">${kcSanitize(msg(messagesPerField.get('password-confirm')))?no_esc}</div>
                                </#if>
