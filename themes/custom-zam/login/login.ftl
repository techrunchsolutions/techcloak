        ...
        <main class="position-relative min-vh-100">
            ...
            <div class="left-content">
                <div class="background-container">
                    <!-- Background Images -->
                    <img
                        src="${url.resourcesPath}/car1.png"
                        alt=""
                    ...
                    <img
                        src="${url.resourcesPath}/car2.png"
                        alt=""
                    ...
                    <img
                        src="${url.resourcesPath}/car3.png"
                        alt=""
                        class="carousel-image"
                        id="carousel-img-3"
                    />
            ...
            <section class="main-content">
                <div class="container-fluid h-100">
                    ...
                    <!-- Login Form -->
                    <form id="kc-form-login" class="mx-auto" style="max-width: 532px" action="${url.loginAction}" method="post">
