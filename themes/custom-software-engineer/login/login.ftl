...
<@layout.registrationLayout displayInfo=social.displayInfo displayWide=(realm.password && social.providers??); section>
    ...
    <#elseif section = "form">
        ...
        <head>
            ...
            <title>${msg("loginTitle",(realm.displayName!''))} | The Software Engineer</title>
                        ...
                        <#if realm.password && social.providers??>
                            ...
                            <div id="kc-social-providers" class="space-y-3">
                                <#list social.providers as p>
                                    <a id="social-${p.alias}" class="button_secondary w-full py-3 flex items-center justify-center gap-2" type="button" href="${p.loginUrl}">
